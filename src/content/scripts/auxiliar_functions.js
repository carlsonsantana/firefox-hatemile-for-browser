...
function getConfiguration() {
	...
	return {
		...
		, 'aria-autocomplete-both-before': getPreference(preferencesBranch, 'aria.autocomplete.both.before')
		, 'aria-autocomplete-both-after': getPreference(preferencesBranch, 'aria.autocomplete.both.after')
		, 'aria-autocomplete-inline-before': getPreference(preferencesBranch, 'aria.autocomplete.inline.before')
		, 'aria-autocomplete-inline-after': getPreference(preferencesBranch, 'aria.autocomplete.inline.after')
		, 'aria-autocomplete-list-before': getPreference(preferencesBranch, 'aria.autocomplete.list.before')
		, 'aria-autocomplete-list-after': getPreference(preferencesBranch, 'aria.autocomplete.list.after')
		, 'aria-busy-true-before': getPreference(preferencesBranch, 'aria.busy.true.before')
		, 'aria-busy-true-after': getPreference(preferencesBranch, 'aria.busy.true.after')
		, 'aria-checked-true-before': getPreference(preferencesBranch, 'aria.checked.true.before')
		, 'aria-checked-true-after': getPreference(preferencesBranch, 'aria.checked.true.after')
		, 'aria-checked-false-before': getPreference(preferencesBranch, 'aria.checked.false.before')
		, 'aria-checked-false-after': getPreference(preferencesBranch, 'aria.checked.false.after')
		, 'aria-checked-mixed-before': getPreference(preferencesBranch, 'aria.checked.mixed.before')
		, 'aria-checked-mixed-after': getPreference(preferencesBranch, 'aria.checked.mixed.after')
		...
		, 'aria-expanded-true-before': getPreference(preferencesBranch, 'aria.expanded.true.before')
		, 'aria-expanded-true-after': getPreference(preferencesBranch, 'aria.expanded.true.after')
		, 'aria-expanded-false-before': getPreference(preferencesBranch, 'aria.expanded.false.before')
		, 'aria-expanded-false-after': getPreference(preferencesBranch, 'aria.expanded.false.after')
		...
		, 'aria-haspopup-true-before': getPreference(preferencesBranch, 'aria.haspopup.true.before')
		, 'aria-haspopup-true-after': getPreference(preferencesBranch, 'aria.haspopup.true.after')
		, 'aria-invalid-true-before': getPreference(preferencesBranch, 'aria.invalid.true.before')
		, 'aria-invalid-true-after': getPreference(preferencesBranch, 'aria.invalid.true.after')
		...
		, 'aria-level-prefix-before': getPreference(preferencesBranch, 'aria.level.prefix.before')
		, 'aria-level-suffix-before': getPreference(preferencesBranch, 'aria.level.suffix.before')
		, 'aria-level-prefix-after': getPreference(preferencesBranch, 'aria.level.prefix.after')
		, 'aria-level-suffix-after': getPreference(preferencesBranch, 'aria.level.suffix.after')
		, 'aria-orientation-vertical-before': getPreference(preferencesBranch, 'aria.orientation.vertical.before')
		, 'aria-orientation-vertical-after': getPreference(preferencesBranch, 'aria.orientation.vertical.after')
		, 'aria-orientation-horizontal-before': getPreference(preferencesBranch, 'aria.orientation.horizontal.before')
		, 'aria-orientation-horizontal-after': getPreference(preferencesBranch, 'aria.orientation.horizontal.after')
		, 'aria-pressed-true-before': getPreference(preferencesBranch, 'aria.pressed.true.before')
		, 'aria-pressed-true-after': getPreference(preferencesBranch, 'aria.pressed.true.after')
		, 'aria-pressed-false-before': getPreference(preferencesBranch, 'aria.pressed.false.before')
		, 'aria-pressed-false-after': getPreference(preferencesBranch, 'aria.pressed.false.after')
		, 'aria-pressed-mixed-before': getPreference(preferencesBranch, 'aria.pressed.mixed.before')
		, 'aria-pressed-mixed-after': getPreference(preferencesBranch, 'aria.pressed.mixed.after')
		...
		, 'aria-selected-true-before': getPreference(preferencesBranch, 'aria.selected.true.before')
		, 'aria-selected-true-after': getPreference(preferencesBranch, 'aria.selected.true.after')
		, 'aria-selected-false-before': getPreference(preferencesBranch, 'aria.selected.false.before')
		, 'aria-selected-false-after': getPreference(preferencesBranch, 'aria.selected.false.after')
		, 'aria-sort-ascending-before': getPreference(preferencesBranch, 'aria.sort.ascending.before')
		, 'aria-sort-ascending-after': getPreference(preferencesBranch, 'aria.sort.ascending.after')
		, 'aria-sort-descending-before': getPreference(preferencesBranch, 'aria.sort.descending.before')
		, 'aria-sort-descending-after': getPreference(preferencesBranch, 'aria.sort.descending.after')
		, 'aria-sort-other-before': getPreference(preferencesBranch, 'aria.sort.other.before')
		, 'aria-sort-other-after': getPreference(preferencesBranch, 'aria.sort.other.after')
		...
		, 'attribute-accesskey-default': getPreference(preferencesBranch, 'attribute.accesskey.default')
		...
		, 'attribute-draggable-before': getPreference(preferencesBranch, 'attribute.draggable.before')
		, 'attribute-draggable-after': getPreference(preferencesBranch, 'attribute.draggable.after')
		, 'attribute-dropzone-copy-before': getPreference(preferencesBranch, 'attribute.dropzone.copy.before')
		, 'attribute-dropzone-copy-after': getPreference(preferencesBranch, 'attribute.dropzone.copy.after')
		, 'attribute-dropzone-move-before': getPreference(preferencesBranch, 'attribute.dropzone.move.before')
		, 'attribute-dropzone-move-after': getPreference(preferencesBranch, 'attribute.dropzone.move.after')
		, 'attribute-dropzone-link-before': getPreference(preferencesBranch, 'attribute.dropzone.link.before')
		, 'attribute-dropzone-link-after': getPreference(preferencesBranch, 'attribute.dropzone.link.after')
		...
		, 'attribute-language-prefix-before': getPreference(preferencesBranch, 'attribute.language.prefix.before')
		, 'attribute-language-suffix-before': getPreference(preferencesBranch, 'attribute.language.suffix.before')
		, 'attribute-language-prefix-after': getPreference(preferencesBranch, 'attribute.language.prefix.after')
		, 'attribute-language-suffix-after': getPreference(preferencesBranch, 'attribute.language.suffix.after')
		, 'attribute-role-prefix-before': getPreference(preferencesBranch, 'attribute.role.prefix.before')
		, 'attribute-role-suffix-before': getPreference(preferencesBranch, 'attribute.role.suffix.before')
		, 'attribute-role-prefix-after': getPreference(preferencesBranch, 'attribute.role.prefix.after')
		, 'attribute-role-suffix-after': getPreference(preferencesBranch, 'attribute.role.suffix.after')
		, 'attribute-headers-prefix-before': getPreference(preferencesBranch, 'attribute.headers.prefix.before')
		, 'attribute-headers-suffix-before': getPreference(preferencesBranch, 'attribute.headers.suffix.before')
		, 'attribute-headers-prefix-after': getPreference(preferencesBranch, 'attribute.headers.prefix.after')
		, 'attribute-headers-suffix-after': getPreference(preferencesBranch, 'attribute.headers.suffix.after')
